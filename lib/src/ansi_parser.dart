...
class AnsiParser {
  ...
  Color? getColor(int colorCode, bool foreground) {
    switch (colorCode) {
      ...
      case 12:
        return dark == true ? Colors.lightBlue[300] : Colors.indigo[700];
      case 208:
        return dark == true ? Colors.orange[300] : Colors.orange[700];
      case 196:
        return dark == true ? Colors.red[300] : Colors.red[700];
      case 199:
        return dark == true ? Colors.pink[300] : Colors.pink[700];
    }
    return null;
  }
