...
class LogConsole extends StatefulWidget {
  ...
  static void init({int bufferSize = 20}) {
    ...
    //TODO
    //print('Listening....................init');
    LoggingLogger.root.level = LoggingLevel.ALL;
    LoggingLogger.root.onRecord.listen((record) {
      print('${record.level.name}: ${record.time}: ${record.message}');
      if (_outputEventBuffer.length == bufferSize) {
        _outputEventBuffer.removeFirst();
      }
      _outputEventBuffer.add(OutputEvent(Level.info, [record.message]));
    });
  }
...
class _LogConsoleState extends State<LogConsole> {
  ...
  void initState() {
    ...
    LoggingLogger.root.onRecord.listen((record) {
      ...
      _renderedBuffer.add(_renderEvent(OutputEvent(Level.info, [record.message])));
      _refreshFilter();
    });*/
  ...
  void dispose() {
    ...
    //TODO
    //LoggingLogger.root.clearListeners();
    super.dispose();
  }
}
